...
| Windows observations v0.4 | Validated on one real Windows 11 x64 host | Dependency-free native system, listener/attribution, and firewall collectors plus the assembled Windows scan path; broader Windows-version and configuration validation remains pending. |
